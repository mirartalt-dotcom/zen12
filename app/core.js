...
var FAQ=[
 [/энергетик|кофеин/i,'DZEN — не энергетик: кофеина ноль. Это газировка с пребиотиками и без сахара. Ровное состояние вместо химического разгона.'],
...
function chatAnswer(text,cb){
  ...
  var sys='Ты — голос банки DZEN (газировка с пребиотиками, 0 г сахара, БЕЗ кофеина — это НЕ энергетик): эксперт мирового уровня по энергии, сну, привычкам, питанию, стрессу и работоспособности.\n'+
  ...
  'ПРО ПРОДУКТ: не упоминай газировку DZEN, банку или Додо Пиццу первым — ты эксперт, не продавец. НО если человек САМ спросил про напиток, цену или где купить — ответь прямо и дружелюбно, без нравоучений: DZEN — газировка без сахара (0 г сахара, ~20 ккал/100 г, пребиотики, ~4 г клетчатки), БЕЗ кофеина — это не энергетик, а лимонад, который просто не роняет тебя сахарными качелями; продаётся в Додо Пицце; про точную цену честно скажи, что она зависит от точки, и предложи посмотреть в Додо. Никогда не отвечай на вопрос о цене фразами вроде «цена не имеет значения» — это грубо.\n'+
